...
<div class="base">
    {#if multiline}
        <textarea name={get_name} {id} {required} {disabled} bind:value bind:this={input} {placeholder} {readonly} />
    {:else}
        <input name={get_name} {id} {required} {disabled} bind:value bind:this={input} {placeholder} {readonly} />
    {/if}
    {#if $$slots.default}
